 ...
 * 接收端和场景1不同点：
 ...
 1）It's a common mistake to miss the basicAck. It's an easy error, but the consequences are serious.
 ...
 2）Note on message persistence
   ...
   If you need a stronger guarantee you can wrap the publishing code in atransaction.

 3）Note about queue size
   If all the workers are busy, your queue can fill up.
   You will want to keep an eye on that,
   and maybe add more workers,
